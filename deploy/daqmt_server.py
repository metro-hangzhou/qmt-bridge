...
DaQMT (大QMT) strategy runtime so that `get_trade_detail_data`,
...
# 0=未报 1=待报 5=部成 (typical DaQMT mapping)
...
class BaseHandler(tornado.web.RequestHandler):
    ...
    def write_json(self, obj, status=200):
        ...
        # ensure_ascii=False so 中文 names survive; UTF-8 via header above.
...
def init(ContextInfo):
    ...
    ContextInfo.accountID = '请在此设置真实资金账号'  # TODO set before deploy
    app = make_app()
